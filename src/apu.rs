...
impl APU {
    ...
    pub fn tick(&mut self) {
        ...
        self.accumulator_ch4.push(self.channel4.get_output());
    ...
    fn mix_samples(&mut self) {
        ...
        let sound4: f32 = self.accumulator_ch4.iter().fold(0.0, |acc, v| acc + (*v as f32)) / (self.accumulator_ch4.len() as f32);
